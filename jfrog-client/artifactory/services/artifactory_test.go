...
import (
	...
	"github.com/AngelloMaggio/jfrog-cli-go/jfrog-client/utils/tests"
	"io/ioutil"
	"net/http"
	"os"
	"path/filepath"
...
const (
	...
	ClientIntegrationTests    = "github.com/AngelloMaggio/jfrog-cli-go/jfrog-client/artifactory/services"
)
